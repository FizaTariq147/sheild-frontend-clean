  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.description}>
        Emergencies require instant response, and that's what we deliver. With
        just a tap, you can connect to lifesaving services. Be prepared at all
        times to face critical situations with confidence.
      </Text>
